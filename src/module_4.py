...
"""
    На ввод подаётся список, выведите только уникальные элементы списка,
    возвращающий в формате типа данных frozenset.
    """


def m_4_4_1(data: list):
    return frozenset(data)


# === Дополнительная Задача 2 ===
"""
    Создайте frozenset, содержащий числа от 1 до 5. Попробуйте:
        - Вывести его на экран.
        - Проверить, содержит ли он число 3.
        - Найти его длину.
   """


def m_4_4_2():
    nums = frozenset(range(1, 6))
    return (nums, 3 in nums, len(nums))


# === Дополнительная Задача 3 ===
"""
    Создайте два frozenset из чисел:
        fset1 = {1, 2, 3, 4, 5}
        fset2 = {4, 5, 6, 7}
    Выполните и выведите результаты
        - Объединение fset1 и fset2.
        - Пересечение fset1 и fset2.
        - Разность fset1 - fset2.
        - Проверьте, является ли fset1 надмножеством для {3, 4}.
    """


def m_4_4_3(fset1=None, fset2=None):
    if not fset1:
        fset1 = {1, 2, 3, 4, 5}
    if not fset2:
        fset2 = {4, 5, 6, 7}
    return (fset1 | fset2, fset1 & fset2, fset1 - fset2, fset1.issuperset)
